...
public class SolrParser implements com.netapp.framework.parser.SAXParser<Map<String,String>>{
	private SAXParser saxParser;

	public SolrParser() throws ParserConfigurationException, SAXException{		
